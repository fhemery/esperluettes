...
Deliberate non-goals: any bulk migration; `author_note`
...
Assumptions taken without asking (A7–A13) are reversible except
A9 (derived mode) — see `DECISIONS.md` in git history before re-litigating any of them.
