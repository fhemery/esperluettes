...
| MultiEdit — advanced mode for static pages                      | `multiedit-static-pages/`       | interactive | WIP:WRAP — README + e2e retired; **propose DONE** (awaiting user confirm). Domain docs to regenerate: StaticPage (must), Editor (consumer list), News (minor — admin field order)                                                                                                                                                                                                                                                                                                           |
