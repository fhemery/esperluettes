...
| ----------------------------------------------------------------- | ------------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| MultiEdit — migrate the remaining ImageService consumers          | `media-consumer-migration/`     | interactive | WIP:BUILD (0/5)                                                                                                                                                                                                            |
| Extract an Editor domain from Shared                              | `editor-domain/`                | interactive | WIP:DESIGN — do before `chapters-multi-edit/`, which adds block logic that should land in Editor, not Shared                                                                                                            |
