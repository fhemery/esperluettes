...
| Task | Folder | Wrapped |
|------|--------|---------|
| MultiEdit — advanced mode for static pages | `multiedit-static-pages/` | 2026-08-01 (user confirmed DONE 2026-08-02; domain docs to regenerate: StaticPage, Editor, News) |
