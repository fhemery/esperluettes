...
**Status:** DONE — 2026-08-01 · **Domain(s):** `StaticPage`, `News` · **Spec:**
...
Deliberate non-goals (`01-functional.md` §8): Chapters/FAQ MultiEdit; stricter
...
Assumptions taken without asking (`DECISIONS.md` A1–A5) are reversible — see
that table before re-litigating any of them.
