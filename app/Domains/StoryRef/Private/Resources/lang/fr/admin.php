...
return [
    ...
    'statuses' => [
        ...
        'edit_title' => 'Modifier le statut :name',
        'create_button' => 'Nouveau statut',
        'edit_button' => 'Modifier',
        'delete_button' => 'Supprimer',
        'export_button' => 'Export CSV',
        ...
        'cannot_delete_in_use' => 'Impossible de supprimer ce statut : il est utilisé par :count histoire(s).',
        'confirm_delete' => 'Êtes-vous sûr de vouloir supprimer ce statut ?',
        'no_statuses' => 'Aucun statut défini.',
        'table' => [
            'order' => 'Ordre',
            'name' => 'Nom',
            'slug' => 'Slug',
        ...
        'form' => [
            'name' => 'Nom',
            'slug' => 'Slug (identifiant URL)',
            'slug_help' => 'Lettres minuscules, chiffres et tirets uniquement (ex: en-cours, termine)',
            'description' => 'Description',
            'is_active' => 'Statut actif (visible dans les formulaires)',
            'create' => 'Créer le statut',
            'update' => 'Mettre à jour',
            'cancel' => 'Annuler',
        ],
        'validation' => [
            ...
            'slug_required' => 'Le slug est obligatoire.',
            'slug_format' => 'Le slug ne peut contenir que des lettres minuscules, des chiffres et des tirets.',
            'slug_unique' => 'Ce slug est déjà utilisé par un autre statut.',
            'order_required' => 'L\'ordre d\'affichage est obligatoire.',
            'order_integer' => 'L\'ordre doit être un nombre entier.',
            'description_max' => 'La description ne peut pas dépasser 1000 caractères.',
        ],
    ...
    'trigger_warnings' => [
        'nav_label' => 'Avertissements',
        'title' => 'Gestion des avertissements de contenu',
        'create_title' => 'Créer un avertissement',
        'edit_title' => 'Modifier l\'avertissement :name',
        'create_button' => 'Nouvel avertissement',
        'edit_button' => 'Modifier',
        'delete_button' => 'Supprimer',
        'export_button' => 'Export CSV',
        'created' => 'Avertissement créé avec succès.',
        'updated' => 'Avertissement mis à jour avec succès.',
        'deleted' => 'Avertissement supprimé avec succès.',
        'cannot_delete_in_use' => 'Impossible de supprimer cet avertissement : il est utilisé par :count histoire(s).',
        'confirm_delete' => 'Êtes-vous sûr de vouloir supprimer cet avertissement ?',
        'no_trigger_warnings' => 'Aucun avertissement défini.',
        'table' => [
            'order' => 'Ordre',
            'name' => 'Nom',
            'slug' => 'Slug',
        ...
        'form' => [
            'name' => 'Nom',
            'slug' => 'Slug (identifiant URL)',
            'slug_help' => 'Lettres minuscules, chiffres et tirets uniquement (ex: violence, langage-vulgaire)',
            'description' => 'Description',
            'is_active' => 'Avertissement actif (visible dans les formulaires)',
            'create' => 'Créer l\'avertissement',
            'update' => 'Mettre à jour',
            'cancel' => 'Annuler',
        ],
        'validation' => [
            ...
            'slug_required' => 'Le slug est obligatoire.',
            'slug_format' => 'Le slug ne peut contenir que des lettres minuscules, des chiffres et des tirets.',
            'slug_unique' => 'Ce slug est déjà utilisé par un autre avertissement.',
            'order_required' => 'L\'ordre d\'affichage est obligatoire.',
            'order_integer' => 'L\'ordre doit être un nombre entier.',
            'description_max' => 'La description ne peut pas dépasser 1000 caractères.',
        ],
    ...
    'types' => [
        ...
        'create_title' => 'Créer un type',
        'edit_title' => 'Modifier le type :name',
        'create_button' => 'Nouveau type',
        'edit_button' => 'Modifier',
        'delete_button' => 'Supprimer',
        'export_button' => 'Export CSV',
        ...
        'cannot_delete_in_use' => 'Impossible de supprimer ce type : il est utilisé par :count histoire(s).',
        'confirm_delete' => 'Êtes-vous sûr de vouloir supprimer ce type ?',
        'no_types' => 'Aucun type défini.',
        'table' => [
            'order' => 'Ordre',
            'name' => 'Nom',
            'slug' => 'Slug',
        ...
        'form' => [
            'name' => 'Nom',
            'slug' => 'Slug (identifiant URL)',
            'slug_help' => 'Lettres minuscules, chiffres et tirets uniquement (ex: roman, nouvelle)',
            'is_active' => 'Type actif (visible dans les formulaires)',
            'create' => 'Créer le type',
            'update' => 'Mettre à jour',
            'cancel' => 'Annuler',
        ...
        'validation' => [
            ...
            'slug_required' => 'Le slug est obligatoire.',
            'slug_format' => 'Le slug ne peut contenir que des lettres minuscules, des chiffres et des tirets.',
            'slug_unique' => 'Ce slug est déjà utilisé par un autre type.',
            'order_required' => 'L\'ordre d\'affichage est obligatoire.',
            'order_integer' => 'L\'ordre doit être un nombre entier.',
        ],
    ],
