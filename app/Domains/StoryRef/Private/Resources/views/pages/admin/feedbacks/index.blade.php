    ...
    @reorder-cancel.window="reordering = false">
        <div class="flex justify-between items-center">
            ...
            <x-story_ref::admin.index-actions
                :exportRoute="route('story_ref.admin.feedbacks.export')"
                :exportLabel="__('story_ref::admin.feedbacks.export_button')"
                :createRoute="route('story_ref.admin.feedbacks.create')"
                :createLabel="__('story_ref::admin.feedbacks.create_button')"
                :itemCount="count($feedbacks)"
            />
        </div>
