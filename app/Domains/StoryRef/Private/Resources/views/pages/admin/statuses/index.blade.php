    ...
    @reorder-cancel.window="reordering = false">
        <div class="flex justify-between items-center">
            ...
            <x-story_ref::admin.index-actions
                :exportRoute="route('story_ref.admin.statuses.export')"
                :exportLabel="__('story_ref::admin.statuses.export_button')"
                :createRoute="route('story_ref.admin.statuses.create')"
                :createLabel="__('story_ref::admin.statuses.create_button')"
                :itemCount="count($statuses)"
            />
        </div>
                ...
                <tbody>
                    @forelse ($statuses as $status)
                        <tr class="border-b border-border/50 hover:bg-surface-read/50">
                            ...
                            <td class="p-3">
                                <x-administration::active-badge :active="$status->is_active" />
                            </td>
                            <td class="p-3">
                                <div class="flex gap-2">
                                    ...
                                    <x-administration::delete-button 
                                        :action="route('story_ref.admin.statuses.destroy', $status)"
                                        :confirm="__('story_ref::admin.statuses.confirm_delete')"
                                        :title="__('story_ref::admin.statuses.delete_button')" />
                                </div>
                            </td>
                        </tr>
                    @empty
