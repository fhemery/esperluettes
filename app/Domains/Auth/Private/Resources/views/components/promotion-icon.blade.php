...
<div class="flex items-center shrink-0">
    <a href="{{ route('auth.admin.promotion-requests.index') }}" class="relative inline-flex items-center p-2 text-fg hover:text-fg/80 focus:outline-hidden transition ease-in-out duration-150">
