<x-app-layout seasonal-background="true">
    <div class="h-full flex flex-col items-center py-8">
        <div class="surface-secondary w-full sm:max-w-xl my-4 px-6 py-4 shadow-md overflow-hidden sm:rounded-lg">
            <!-- Session Status -->
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <a class="text-on-surface underline text-sm hover:text-on-surface/90 rounded-md focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('password.request') }}">
