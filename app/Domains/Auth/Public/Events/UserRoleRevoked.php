...
class UserRoleRevoked implements DomainEvent, AuditableEvent
{
    ...
    public static function name(): string { return 'Auth.UserRoleRevoked'; }
    ...
    public function summary(): string
    {
        ...
        $key = $isSystem ? 'auth::events.user_role_revoked.system.summary' : 'auth::events.user_role_revoked.summary';
        return trans($key, [
            'role' => $this->role,
            'id' => $this->userId,
        ]);
