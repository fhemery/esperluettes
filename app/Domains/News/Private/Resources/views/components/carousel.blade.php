...
>
    ...
    <button type="button" @click="prev()" class="absolute inset-y-0 left-2 my-auto h-10 w-10 rounded-full bg-white/80 hover:bg-white shadow flex items-center justify-center" aria-label="{{ __('news::public.carousel.prev') }}">
        <span aria-hidden="true">‹</span>
    </button>
    <button type="button" @click="next()" class="absolute inset-y-0 right-2 my-auto h-10 w-10 rounded-full bg-white/80 hover:bg-white shadow flex items-center justify-center" aria-label="{{ __('news::public.carousel.next') }}">
        <span aria-hidden="true">›</span>
    </button>
