<x-app-layout seasonal-background="true">
    <div class="flex flex-col h-full items-center justify-center py-12 px-8 flex-1" data-test-id="home-page">
        ...
        <div class="w-full max-w-[600px] bg-secondary/90 text-white rounded-lg shadow-xl px-6 py-4">
            ...
            <div class="mt-4 flex items-center justify-center">
                <a href="{{ route('register') }}">
                    <x-shared::button color="accent">{{ __('home::index.join-us') }}</x-shared::button>
                </a>
            </div>
        </div>
    </div>
