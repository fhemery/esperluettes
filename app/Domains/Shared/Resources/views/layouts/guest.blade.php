<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-season="{{ $theme->value }}" data-appearance="{{ $appearance ?? 'light' }}" data-font="{{ $userFont ?? 'aptos' }}" data-interline="{{ $userInterline ?? 'medium' }}" class="h-full">
