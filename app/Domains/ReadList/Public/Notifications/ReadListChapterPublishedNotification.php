...
class ReadListChapterPublishedNotification implements NotificationContent
{
    ...
    {
        return 'readlist.chapter.published';
    }
    ...
    public function display(): string
    {
        ...
        return __('readlist::notification.chapter_published', [
            'author_name' => $this->authorName,
