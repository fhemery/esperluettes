...
class ReadListStoryUnpublishedNotification implements NotificationContent
{
    ...
    {
        return 'readlist.story.unpublished';
    }
    ...
    public function display(): string
    {
        ...
        return __('readlist::notification.story_unpublished', [
            'author_name' => $this->authorName,
