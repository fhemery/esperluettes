    ...
    <div class="grid grid-cols-4 gap-6">
        ...
        <div class="col-span-4 md:col-span-1 flex flex-col gap-2">
            ...
            <x-shared::select-with-tooltips
                name="story_ref_type_id"
                :options="$referentials['types'] ?? []"
                :selected="$selectedTypeId"
                :placeholder="__('story::shared.type.placeholder')"
                valueField="id"
                labelField="name"
        ...
        <div class="col-span-4 md:col-span-2 flex flex-col gap-2">
            ...
            <x-shared::select-with-tooltips
                name="story_ref_copyright_id"
                :options="$referentials['copyrights'] ?? []"
                :selected="$selectedCopyrightId"
                :placeholder="__('story::shared.copyright.placeholder')"
                valueField="id"
                labelField="name"
                descriptionField="description"
                :required="true"
...
<x-shared::collapsible :title="__('story::shared.panels.details')" :open="true">
    <div class="grid grid-cols-4 gap-6">
        ...
        <div class="col-span-4 md:col-span-2 flex flex-col gap-2">
            ...
            <x-shared::select-with-tooltips
                name="story_ref_status_id"
                :options="$referentials['statuses'] ?? []"
                :selected="$selectedStatusId"
                :placeholder="__('story::shared.status.placeholder')"
                valueField="id"
                labelField="name"
                descriptionField="description"
                color="accent" />
        ...
        <div class="col-span-4">
            ...
            <x-shared::editor id="story-description-editor" name="description" :min="100" :max="1000" :nbLines="10" defaultValue="{{ old('description', $story?->description ?? '') }}" />
...
<x-shared::collapsible :title="__('story::shared.panels.audience')" :open="true">
    <div class="grid grid-cols-4 gap-6">
        ...
        <div class="col-span-4 md:col-span-2 flex gap-2">
            ...
            <x-shared::select-with-tooltips
                name="story_ref_audience_id"
                :options="$referentials['audiences'] ?? []"
                :selected="$selectedAudienceId"
        ...
        <div class="col-span-4 flex flex-col gap-2"
            ...
            <div class="flex flex-col sm:flex-row gap-2 w-full">
                ...
                <div class="min-w-32">
                    <x-shared::select-with-tooltips
                        name="tw_disclosure"
                        :options="$twDisclosureOptions"
                        :selected="$twDisclosureOld"
                        valueField="value"
                        labelField="label"
                        descriptionField="description"
                        color="accent" />
...
<x-shared::collapsible :title="__('story::shared.panels.misc')" :open="true">
    <div class="flex flex-col gap-2">
        ...
        <x-shared::select-with-tooltips
            name="story_ref_feedback_id"
            :options="$referentials['feedbacks'] ?? []"
            :selected="$selectedFeedbackId"
            :placeholder="__('story::shared.feedback.placeholder')"
            valueField="id"
            labelField="name"
            descriptionField="description"
            color="accent" />
