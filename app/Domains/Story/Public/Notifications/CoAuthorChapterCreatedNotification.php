...
class CoAuthorChapterCreatedNotification implements NotificationContent
{
    ...
    {
        return 'story.coauthor.chapter.created';
    }
    ...
    public function display(): string
    {
        ...
        return __('story::notification.chapter.created', [
            'user_name' => $this->userName,
            'user_url' => $userUrl,
