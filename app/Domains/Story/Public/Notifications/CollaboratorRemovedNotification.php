...
class CollaboratorRemovedNotification implements NotificationContent
{
    ...
    {
        return 'story.collaborator.removed';
    }
    ...
    public function display(): string
    {
        ...
        return __('story::notification.collaborator.removed', [
            'user_name' => $this->userName,
            'user_url' => $userUrl,
