...
Delivery preferences are documented below in [Delivery Channels](#delivery-channels) and [User Preferences](#user-preferences); Discord delivery has its own record in [docs/Feature_Planning/discord-notifications/](../../../docs/Feature_Planning/discord-notifications/README.md).
