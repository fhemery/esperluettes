...
The source code is under MIT License. The images are under All Rights Reserved license.
See the separate [LICENSE](LICENSE) and [public/images/LICENSE](public/images/LICENSE) files for details.